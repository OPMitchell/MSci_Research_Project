...
In short, with a greater amount of gameplay content comes unfeasible exponential growth in the number of branches of a narrative tree structure. Developers are then forced to simplify the story, resulting in less player interactivity. This reduces player agency, and prevents the player from being immersed in a believable game-world.

Louchart et al. suggest abandoning the branching tree structure, and rethinking the design process entirely...
